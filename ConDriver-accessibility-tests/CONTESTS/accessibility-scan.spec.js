/**
 * ===========================================
 * ACCESSIBILITY SCAN TEST — CONTINUUM EMPLOYEE
 * ===========================================
 * Runs axe-core accessibility scans against all pages
 * in Chrome, Firefox and Edge.
 *
 * Generates ONE consolidated HTML report at:
 *   ConDriver-results/YYYY-MM-DD/report.html
 *
 * HOW TO RUN:
 * All browsers:   npx playwright test --config=condriver.config.js
 * One browser:    npx playwright test --config=condriver.config.js --project=chromium
 * One page:       npx playwright test --config=condriver.config.js --grep "Login Page"
 * ===========================================
 */
...
const resultsDir = path.join(__dirname, '..', 'ConDriver-results', today);
...
// Report generation and Teams notification are handled by utils/condriver-teardown.js

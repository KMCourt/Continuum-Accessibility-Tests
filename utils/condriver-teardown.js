...
module.exports = async function globalTeardown() {
  ...
  const baseResultsDir = path.join(__dirname, '..', 'ConDriver-accessibility-tests', 'ConDriver-results');
  ...
  generateConsolidatedReport({
    ...
    reportLabel: 'TTC Continuum — ConDriver Accessibility Report',
  });
  ...
  console.log('\n========================================');
  console.log('  CONDRIVER SCAN COMPLETE');
  console.log('========================================');

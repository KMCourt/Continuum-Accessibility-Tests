...
module.exports = async function globalTeardown() {
  ...
  const baseResultsDir = path.join(__dirname, '..', 'ConManager-accessibility-tests', 'ConManager-results');
  ...
  generateConsolidatedReport({
    ...
    reportLabel: 'TTC Continuum — ConManager Accessibility Report',
  });
  ...
  console.log('\n========================================');
  console.log('  CONMANAGER SCAN COMPLETE');
  console.log('========================================');
  ...
  console.log('========================================');
  console.log(`\n✅ Report: ConManager-accessibility-tests/ConManager-results/${today}/report.html`);
  ...
  await postToTeams({
    ...
    label: 'ConManager Accessibility Scan',
    topRule,
  });
